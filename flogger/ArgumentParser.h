...
public:
	...
	void printHelp(const std::string& header, bool hasNonSwitchArguments, bool wideString) const;
	void printHelp(const std::wstring& header, bool hasNonSwitchArguments) const;
